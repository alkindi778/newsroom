        ...
        <form action="{{ route('admin.roles.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" required
                       placeholder="مثال: المحرر"
                       class="w-full rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('name') border-red-300 @else border-gray-300 @enderror">
                @error('name')
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.permissions-category').forEach(function(category) {
        const selectAllBtn = category.querySelector('.select-all-permissions');
