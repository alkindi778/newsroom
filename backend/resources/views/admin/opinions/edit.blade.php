...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div class="mb-4 sm:mb-0">
            ...
            <p class="mt-1 text-sm text-gray-600">{{ $opinion->title }}</p>
        </div>
        
        <div class="flex flex-col sm:flex-row gap-3">
            <a href="{{ route('admin.opinions.show', $opinion) }}" 
    ...
    <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200">
        <form action="{{ route('admin.opinions.update', $opinion) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="px-6 py-4 border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="writer_id" 
                            ...
                            <option value="{{ $writer->id }}" {{ old('writer_id', $opinion->writer_id) == $writer->id ? 'selected' : '' }}>
                                {{ $writer->name }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select name="is_published" 
                            ...
                            <option value="0" {{ old('is_published', $opinion->is_published) == '0' ? 'selected' : '' }}>مسودة</option>
                            <option value="1" {{ old('is_published', $opinion->is_published) == '1' ? 'selected' : '' }}>نشر المقال</option>
                        </select>
                        @error('is_published')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                ...
                <div class="mt-6">
                    ...
                    <textarea name="excerpt" 
                              ...
                              placeholder="مقدمة مختصرة عن المقال...">{{ old('excerpt', $opinion->excerpt) }}</textarea>
                    @error('excerpt')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mt-6">
                    ...
                    <textarea name="content" 
                              ...
                              required>{{ old('content', $opinion->content) }}</textarea>
                    @error('content')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mt-6">
                    ...
                    <x-admin.media-picker 
                        field="image" 
                        label="صورة المقال" 
                        :value="old('image', $opinion->image_url ?? '')"
                        collection="opinions"
            ...
            <div class="px-6 py-4 border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="flex items-center">
                        ...
                        <input type="checkbox" 
                               ...
                               id="allow_comments"
                               value="1"
                               {{ old('allow_comments', $opinion->allow_comments) ? 'checked' : '' }}
                               class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                ...
                <div class="mt-6">
                    ...
                    <input type="text" 
                           name="tags" 
                           id="tags"
                           value="{{ old('tags', is_array($opinion->tags) ? implode(', ', $opinion->tags) : $opinion->tags) }}"
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               name="meta_title" 
                               id="meta_title"
                               value="{{ old('meta_title', $opinion->meta_title) }}"
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" 
                                  ...
                                  placeholder="وصف المقال في محركات البحث (160 حرف كحد أقصى)">{{ old('meta_description', $opinion->meta_description) }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="text" 
                               name="keywords" 
                               id="keywords"
                               value="{{ old('keywords', $opinion->keywords) }}"
