...
@section('title', 'تعديل الكاتب: ' . $writer->name)
@section('page-title', 'تعديل الكاتب')
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div class="mb-4 sm:mb-0">
            <h1 class="text-2xl font-bold text-gray-900">تعديل الكاتب: {{ $writer->name }}</h1>
            <p class="mt-1 text-sm text-gray-600">تحديث معلومات الكاتب</p>
        </div>
        
        <div class="flex flex-col sm:flex-row gap-3">
            <a href="{{ route('admin.writers.show', $writer) }}" 
               class="inline-flex items-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors duration-200">
            ...
            <div class="px-6 py-4 border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="email" 
                               ...
                               class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm {{ $errors->has('email') ? 'border-red-500' : 'border-gray-300' }}"
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm {{ $errors->has('phone') ? 'border-red-500' : 'border-gray-300' }}"
                    ...
                    <div>
                        ...
                        <input type="text" 
                               name="position" 
                               id="position"
                               value="{{ old('position', $writer->position) }}"
                    ...
                    <div>
                        ...
                        <input type="text" 
                               name="specialization" 
                               id="specialization"
                               value="{{ old('specialization', $writer->specialization) }}"
                               class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm {{ $errors->has('specialization') ? 'border-red-500' : 'border-gray-300' }}"
                    ...
                    <div>
                        ...
                        <select name="is_active" 
                            ...
                            <option value="1" {{ old('is_active', $writer->is_active) == '1' ? 'selected' : '' }}>نشط</option>
                            <option value="0" {{ old('is_active', $writer->is_active) == '0' ? 'selected' : '' }}>غير نشط</option>
                        </select>
                        @error('is_active')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                ...
                <div class="mt-6">
                    ...
                    <textarea name="bio" 
                              ...
                              placeholder="نبذة مختصرة عن الكاتب...">{{ old('bio', $writer->bio) }}</textarea>
                    @error('bio')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mt-6">
                    ...
                    <x-admin.media-picker 
                        field="image" 
                        label="صورة الكاتب" 
                        :value="old('image', $writer->image_url ?? '')"
                        collection="writers"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="url" 
                               name="facebook_url" 
                               id="facebook_url"
                               value="{{ old('facebook_url', $writer->facebook_url) }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               name="twitter_url" 
                               id="twitter_url"
                               value="{{ old('twitter_url', $writer->twitter_url) }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               name="linkedin_url" 
                               id="linkedin_url"
                               value="{{ old('linkedin_url', $writer->linkedin_url) }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               name="website_url" 
                               id="website_url"
                               value="{{ old('website_url', $writer->website_url) }}"
