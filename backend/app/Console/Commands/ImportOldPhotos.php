...
class ImportOldPhotos extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'media:import-old-photos';
     ...
     * @var string
     */
    protected $description = 'Import old photos from old_photos folder to media library';
    ...
    {
        $this->info('🚀 Starting import of old photos...');

        $disk = 'public';
        $directory = 'old_photos';
        
        // Get all files from old_photos directory recursively
        ...
        foreach ($files as $file) {
            try {
                ...
                DB::table('media')->insert([
                    'model_type' => 'App\\Models\\Article', // Default model type
                    'model_id' => 0, // Not attached to any model
