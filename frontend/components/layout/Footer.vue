  ...
  <footer class="bg-navy-900 text-white mt-16">
    <div class="container mx-auto px-4 py-12">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        <!-- عن الموقع -->
        <div class="text-right relative" style="min-height: 200px;">
          <img 
            v-if="footerLogo || siteLogo" 
            :src="footerLogo || siteLogo" 
            :alt="siteName"
            style="width: 400px !important; height: auto !important; position: absolute !important; top: 0 !important; right: 0 !important; z-index: 1 !important;"
            class="mb-4"
        ...
        <div>
          ...
          <div class="flex gap-3 flex-wrap">
            ...
            <a v-if="socialYoutube" :href="socialYoutube" target="_blank" rel="noopener" class="social-icon">
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
/* Force logo size and positioning */
footer img {
...
@media (max-width: 768px) {
  ...
  .text-right div[style*="padding-top"] {
