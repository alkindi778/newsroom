<template>
  <div class="relative" v-click-outside="closeDropdown">
    ...
    >
      ...
      <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 sm:h-4 sm:w-4 transition-transform duration-200" :class="{ 'rotate-180': isOpen }" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    >
      ...
      >
        ...
        >
          ...
          <svg v-if="localeItem.code === currentCode" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-primary" viewBox="0 0 20 20" fill="currentColor">
