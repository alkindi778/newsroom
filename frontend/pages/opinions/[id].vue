        ...
        <div class="p-4 sm:p-6 md:p-8" :class="{ 'pt-12': !opinion.image }">
          ...
          <div class="mt-12 pt-8 border-t border-gray-200">
            ...
            <div class="flex flex-wrap items-center gap-3">
              <!-- فيسبوك -->
              <button 
                @click="shareOnFacebook(opinionUrl, getOpinionTitle)"
              ...
              <!-- تويتر/X -->
              <button 
                @click="shareOnTwitter(opinionUrl, getOpinionTitle)"
              ...
              <!-- واتساب -->
              <button 
                @click="shareOnWhatsApp(opinionUrl, getOpinionTitle)"
              ...
              <!-- تيليجرام -->
              <button 
                @click="shareOnTelegram(opinionUrl, getOpinionTitle)"
...
const copyOpinionUrl = async () => {
  if (process.client && navigator.clipboard) {
    try {
      const textToCopy = buildShareText(getOpinionTitle.value, opinionUrl.value)
