        ...
        <div class="p-4 sm:p-6 md:p-12 lg:p-16">
          ...
          <div class="mt-12 pt-8 border-t border-gray-200">
            ...
            <div class="flex flex-wrap items-center gap-3">
              <!-- فيسبوك -->
              <button 
                @click="shareOnFacebook(articleUrl, displayArticle.title)"
              ...
              <!-- تويتر/X -->
              <button 
                @click="shareOnTwitter(articleUrl, displayArticle.title)"
              ...
              <!-- واتساب -->
              <button 
                @click="shareOnWhatsApp(articleUrl, displayArticle.title)"
              ...
              <!-- تيليجرام -->
              <button 
                @click="shareOnTelegram(articleUrl, displayArticle.title)"
...
// دالة نسخ رابط المقال مع التوقيع
const copyArticleUrl = async () => {
  if (process.client && navigator.clipboard && displayArticle.value) {
    try {
      const textToCopy = buildShareText(displayArticle.value.title, articleUrl.value)
